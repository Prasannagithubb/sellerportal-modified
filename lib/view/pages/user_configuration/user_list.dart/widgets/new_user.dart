                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                        ...
                        onChanged: (value) {
                          // setState(() {
                          widget.controller.reportinguser = value;
                          // });
                        },
                        // onTap: () {
                        //   setState(() {
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                        ...
                        // isDense: true,
                        items:
                            widget.usertypelist.map<DropdownMenuItem<String>>(
                          (e) {
                            return DropdownMenuItem<String>(
                              value: e.code,
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                        ...
                        value: widget.controller.valueDesignation,
                        isExpanded: true,
                        onChanged: (value) {
                          // setState(() {
                          widget.controller.valueDesignation = value;
                          // });
                        },
                        validator: widget.controller.basicValidator
                    ...
                    CommonValidationForm(
                      ...
                      iconOnPressed: () async {
                        ...
                        if (result?.files.isNotEmpty ?? false) {
                          setState(() {
                            widget.controller.uploadfileField =
                                result!.files[0];
                          });
                        }
                  ...
                  children: [
                    ...
                    DropdownButtonFormField(
                        ...
                        items: <DropdownMenuItem<String>>[
                          DropdownMenuItem(
                            value: 'Retailer',
                            child: MyText.bodySmall('Retailer'),
                          ),
                          DropdownMenuItem(
                            value: 'B2B',
                        ...
                        onChanged: (value) {
                          // setState(() {
                          widget.controller.templateType = value;
                          // });
                        },
                        validator: widget.controller.basicValidator
                ...
                child: Row(
                  children: [
                    ...
                    Switch(
                      onChanged: (vval) {
                        setState(() {
                          widget.controller.ismobileUser = vval;
                        });
                      },
                ...
                child: Row(
                  children: [
                    ...
                    Switch(
                      onChanged: (vval) {
                        setState(() {
                          widget.controller.isPortaluser = vval;
                        });
                      },
          ...
          Row(
            ...
            children: [
              ...
              MyButton(
                onPressed: () {
                  setState(() {
                    widget.controller.validateFinalAddNewUser();
                  });
                },
                elevation: 0,
                padding: MySpacing.xy(20, 16),
