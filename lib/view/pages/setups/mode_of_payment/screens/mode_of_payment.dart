...
class ModeOfPaymentScreen extends StatefulWidget {
  const ModeOfPaymentScreen({super.key});

  @override
  State<ModeOfPaymentScreen> createState() => _ModeOfPaymentScreenState();
}
...
class _ModeOfPaymentScreenState extends State<ModeOfPaymentScreen>
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText.titleMedium("Mode Of Payment",
                              fontSize: 18, fontWeight: 600),
                          MyBreadcrumb(
                            children: [
                              MyBreadcrumbItem(name: 'sellerkit'),
                              MyBreadcrumbItem(
                                  name: 'mode of payment', active: true)
                            ],
                          ),
                        ],
                      ),
