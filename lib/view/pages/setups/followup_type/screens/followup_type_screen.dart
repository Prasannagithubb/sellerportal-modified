...
class FollowupTypeScreen extends StatefulWidget {
  const FollowupTypeScreen({super.key});

  @override
  State<FollowupTypeScreen> createState() => _FollowupTypeScreenState();
}
...
class _FollowupTypeScreenState extends State<FollowupTypeScreen>
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText.titleMedium("Followup Type",
                              fontSize: 18, fontWeight: 600),
                          MyBreadcrumb(
                            children: [
                              MyBreadcrumbItem(name: 'sellerkit'),
                              MyBreadcrumbItem(
                                  name: 'followup type', active: true)
                            ],
                          ),
                        ],
                      ),
