...
class ReferalTypeScreen extends StatefulWidget {
  const ReferalTypeScreen({super.key});

  @override
  State<ReferalTypeScreen> createState() => _ReferalTypeScreenState();
}
...
class _ReferalTypeScreenState extends State<ReferalTypeScreen>
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText.titleMedium("Referal Type",
                              fontSize: 18, fontWeight: 600),
                          MyBreadcrumb(
                            children: [
                              MyBreadcrumbItem(name: 'sellerkit'),
                              MyBreadcrumbItem(
                                  name: 'referal type', active: true)
                            ],
                          ),
                        ],
                      ),
