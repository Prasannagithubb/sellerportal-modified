...
class SettleTypeScreen extends StatefulWidget {
  const SettleTypeScreen({super.key});

  @override
  State<SettleTypeScreen> createState() => _SettleTypeScreenState();
}
...
class _SettleTypeScreenState extends State<SettleTypeScreen>
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText.titleMedium("Settle Type",
                              fontSize: 18, fontWeight: 600),
                          MyBreadcrumb(
                            children: [
                              MyBreadcrumbItem(name: 'sellerkit'),
                              MyBreadcrumbItem(
                                  name: 'settle type', active: true)
                            ],
                          ),
                        ],
                      ),
