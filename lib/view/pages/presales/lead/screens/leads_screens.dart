import 'dart:convert';
import 'package:flowkit/controller/pages/pre_sales/lead_controller.dart';
...
class _LeadScreenState extends State<LeadScreen>
                  ...
                  children: [
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          MyText.titleMedium("Leads",
                              fontSize: 18, fontWeight: 600),
                          MyBreadcrumb(
                            children: [
                              MyBreadcrumbItem(name: 'sellerkit'),
                              MyBreadcrumbItem(name: 'leads', active: true)
                            ],
                          ),
                        ],
                      ),
  ...
  Future<void> _createExcel(String exceltype) async {
    ...
    sheet.getRangeByIndex(1, 1).setText("Lead ID");
    sheet.getRangeByIndex(1, 2).setText("Lead Date");
    ...
    sheet.getRangeByIndex(1, 8).setText("PinCode");
    sheet.getRangeByIndex(1, 9).setText("City ");
    sheet.getRangeByIndex(1, 10).setText("State");

    sheet.getRangeByIndex(1, 11).setText("Status");

    for (var i = 0; i < controller!.filteddata!.length; i++) {
      final item = controller!.filteddata![i];
      sheet.getRangeByIndex(i + 2, 1).setText(item.leadDocEntry.toString());
      sheet.getRangeByIndex(i + 2, 2).setText(item.createdDate);
      ...
      sheet.getRangeByIndex(i + 2, 6).setText(item.mobile);
      sheet.getRangeByIndex(i + 2, 7).setText(item.add1);

      sheet.getRangeByIndex(i + 2, 8).setText(item.pincode.toString());
      sheet.getRangeByIndex(i + 2, 9).setText(item.city);
      sheet.getRangeByIndex(i + 2, 10).setText(item.state);
      sheet.getRangeByIndex(i + 2, 11).setText(item.status);
    }
    ...
    return DataRow.byIndex(
      ...
      cells: [
        DataCell(
          ...
          width: width * 0.08,
          child: MyText.bodySmall(
            data![index].leadDocEntry == -1
                ? ''
                : '${data![index].leadDocEntry.toString()}',
        ...
        DataCell(SizedBox(
          width: width * 0.12,
          child: MyText.bodySmall(
            data![index].createdDate!.isNotEmpty
                ? utils.currentDateFormat(data![index].createdDate!)
                : '',
        ...
        DataCell(SizedBox(
            width: width * 0.12,
            child: MyText.bodySmall(data![index].mobile!.toString()))),
        DataCell(SizedBox(
            width: width * 0.12,
            child: MyText.bodySmall(data![index].add1!.toString()))),
        DataCell(SizedBox(
            width: width * 0.12,
        ...
        DataCell(SizedBox(
            width: width * 0.12,
            child: data![index].status!.isEmpty
                ? Row(
                    children: [SizedBox()],
                  )
                : Row(
        ...
        DataCell(
          SizedBox(
            width: width * 0.12,
            child: data![index].leadDocEntry == -1
                ? Row(
                    children: [
                      SizedBox(),
                    ],
