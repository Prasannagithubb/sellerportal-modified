          ...
          Expanded(
            child: Row(
              ...
              children: [
                ...
                //           'assets/images/logo/${ThemeCustomizer.instance.currentLanguage.locale.languageCode}.svg',
                //           clipBehavior: Clip.antiAliasWithSaveLayer,
                //           height: 18)),
                    ...
                    child: Row(
                      ...
                      children: [
                        Row(
                          ...
                          children: [
                            MyText.labelLarge("Adminstrator", fontWeight: 600),
                            MySpacing.width(8),
                        ...
                        MySpacing.width(8),
                        MyContainer.rounded(bordered: true,
                            paddingAll: 0,border: Border.all(color: Colors.grey[200]!),
                            child: Image.asset(
                              'assets/images/logo/LogoSkHeader.png',
                              height: height*0.15,
                              width: width*0.02,
                              fit: BoxFit.cover,
                            )),
