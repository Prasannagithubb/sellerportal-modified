...
class AppTheme {
  ...
  static Color primaryColor =   Color(0xFF750537);
  ...
  static final ThemeData lightTheme = ThemeData(
    ...
    appBarTheme: AppBarTheme(
        ...
        iconTheme: IconThemeData(color: Color(0xFF750537)),
        actionsIconTheme: IconThemeData(color: Color(0xFF750537))),
    ...
    colorScheme: ColorScheme.fromSeed(
      seedColor: Color(0xFF750537),//0xff006a64
    ...
    tabBarTheme: TabBarTheme(
      unselectedLabelColor: Color(0xFF750537),
  ...
  static void initMyStyle() {
    ...
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: '', route: '/client/home'),
    ));
    bool isMobile = true;
    try {
